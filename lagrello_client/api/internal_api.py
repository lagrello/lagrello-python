    ...
    def __init__(self, api_client=None):
        ...
        def __tenants_cardtoken(
            ...
            **kwargs
            ...
            >>> thread = api.tenants_cardtoken(async_req=True)
            >>> result = thread.get()
        ...
        self.tenants_cardtoken = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'token'
                ],
                'endpoint_path': '/v1/tenant/cardtoken',
                'operation_id': 'tenants_cardtoken',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
