...
class TenantCompanyInfo(ModelNormal):
    ...
    attribute_map = {
        ...
        'org_number': 'OrgNumber',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, address, city, postal_code, country, org_number, vat_number, *args, **kwargs):  # noqa: E501
        """TenantCompanyInfo - a model defined in OpenAPI
