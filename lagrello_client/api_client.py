...
from lagrello_client import rest
from lagrello_client.configuration import Configuration
from lagrello_client.exceptions import ApiTypeError, ApiValueError, ApiException
from lagrello_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.users_email_auth  # this is an instance of the class Endpoint
        api_instance.users_email_auth()  # this invokes api_instance.users_email_auth.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.users_email_auth.callable or self.callable in this class
